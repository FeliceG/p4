...
<p>You can edit the information that was provided for the primary and secondary authors for
  the ressearch paper or poster you submitted for the Coaching in Leadership and Healthcare
  2016 conference, scheduled September 16-17, 2016. Once you have edited the information,
  click "Submit" to save your changes</p>
...
<form method="POST" id="authorform" action="/authors/edit">


<!-- CSRF token for safety -->
    <input type="hidden" name="_token" value="{{ csrf_token() }}" >

    <input type="text" form="authorform" name="research_id" value=" {{ author->research_id }}  " >
